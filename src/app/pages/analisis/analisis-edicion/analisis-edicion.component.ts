...
//           this.pidpaciente = _lista[i].idPaciente;
//           this.pnombres = _lista[i].nombres;
//           this.papellidos = _lista[i].apellidos;
//           this.pdireccion = _lista[i].direccion;
//           this.pdni = _lista[i].dni;
//           this.ptelefono = _lista[i].telefono;
//           this.pfecnac = new Date(parseInt(arrFecha[0]), parseInt(arrFecha[1]) - 1, parseInt(arrFecha[2]));
//           this.pedad = _lista[i].edad;
//           this.psexo = _lista[i].sexo;
//         }
//       }
//     });
